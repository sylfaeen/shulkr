...
function getServerNavSections(
  ...
  if (can('server:webhooks')) items.push({ key: 'webhooks', path: `${basePath}/webhooks`, icon: Bell });
  if (can('server:alerts')) items.push({ key: 'alerts', path: `${basePath}/alerts`, icon: ShieldAlert });
