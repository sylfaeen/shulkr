...
FeatureCard.Title = function FeatureCardTitle({ count, className, children, ...rest }: ComponentProps<'h3'> & { count?: ReactNode }) {
  return (
...
FeatureCard.RowLabel = function FeatureCardRowLabel({ description, className, children, ...rest }: ComponentProps<'div'> & { description?: ReactNode }) {
  return (
...
FeatureCard.Footer = function FeatureCardFooter({ className, alert = false, ...rest }: ComponentProps<'div'> & { alert?: boolean }) {
...
FeatureCard.Empty = function FeatureCardEmpty({ icon: Icon, title, description, children }: PropsWithChildren<{ icon: LucideIcon; title: string; description: string }>) {
  return (
