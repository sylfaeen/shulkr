        ...
        <FeatureCard.Header>
          <FeatureCard.Content>
            <div className={'flex items-center justify-start gap-2'}>
              ...
              <Button onClick={() => setGuidelinesOpen(true)} variant={'ghost'} size={'icon-xs'} icon={Info} iconClass={'size-3'} />
            </div>
            ...
            <>
              <TooltipProvider delayDuration={300}>
                ...
                {canRemove && (
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button onClick={() => setGateRuleId(rule.id)} variant={'ghost-destructive'} size={'icon-sm'} icon={Trash2} />
                    </TooltipTrigger>
