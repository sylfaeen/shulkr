...
import { z } from 'zod';
import { Check, Cloud, ExternalLink, HardDrive, Loader2, Server, X, Zap } from 'lucide-react';
import {
  Dialog,
  DialogBody,
  DialogContent,
      ...
      <DialogContent className={'max-w-2xl'}>
        ...
        <DialogBody>
          ...
          <div className={'mt-4 space-y-2'}>
            <Button type={'button'} variant={'secondary'} onClick={handleTest} disabled={testMutation.isPending}>
              {testMutation.isPending ? <Loader2 className={'size-4 animate-spin'} /> : <Check className={'size-4'} />}
