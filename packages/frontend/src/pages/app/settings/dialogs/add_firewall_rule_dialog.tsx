...
type CreateFirewallFormProps = Pick<AddFirewallRuleDialogProps, 'onAdd' | 'existingRules'>;

function CreateFirewallForm({ onAdd, existingRules }: CreateFirewallFormProps) {
  const { t } = useTranslation();
