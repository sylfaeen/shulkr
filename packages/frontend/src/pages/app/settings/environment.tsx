...
function EnvironmentSection() {
  ...
  useEffect(() => {
    if (editorRef.current) {
      editorRef.current.updateOptions({ readOnly: !revealed || !can('settings:environment:write') });
    }
  }, [revealed]);
                ...
                >
                  <Editor
                    ...
                    options={{
                      ...
                      readOnly: !revealed || !can('settings:environment:write'),
                      lineHeight: 20,
                      glyphMargin: false,
                      folding: false,
            ...
            <FeatureCard.Footer>
              <div className={'flex items-center justify-end gap-2'}>
                ...
                <Button
                  onClick={handleSave}
                  size={'sm'}
                  disabled={!can('settings:environment:write') || !hasChanges || saveStatus === 'saving'}
                >
