...
export function FirstServerWizardPage() {
  ...
  const handleFinish = form.handleSubmit(handleCreate);
                ...
                <div className={'flex items-center justify-between'}>
                  ...
                  <div className={'flex items-center gap-2'}>
                    ...
                    {step < TOTAL_STEPS ? (
                      ...
                      <Button type={'button'} onClick={handleFinish} disabled={!canAdvance || createServer.isPending}>
        ...
        {types.map((value) => {
          ...
          return (
            <Button
              ...
              className={cn(
                'block h-auto w-full rounded-lg border p-4 text-left whitespace-normal transition',
                active
        ...
        {presets.map((p) => {
          ...
          return (
            <Button
              ...
              className={cn(
                'block h-auto w-full rounded-lg border p-3 text-left whitespace-normal transition',
                active
                  ? 'border-sky-500/50 bg-sky-500/5'
                  : 'border-black/8 bg-white hover:border-black/15 dark:border-white/8 dark:bg-zinc-900/40'
              )}
                      ...
                      <SelectTrigger>
                        <SelectValue placeholder={t('wizard.firstServer.stepBackup.selectDestination')}>
                          {(value: string) => {
                            ...
                            return dest ? `${dest.name} (${dest.bucket})` : t('wizard.firstServer.stepBackup.selectDestination');
                          }}
                        </SelectValue>
                      </SelectTrigger>
                    </FormControl>
