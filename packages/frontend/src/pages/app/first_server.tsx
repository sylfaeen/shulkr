        ...
        {types.map((value) => {
          ...
          return (
            <Button
              ...
              className={cn(
                'block h-auto w-full whitespace-normal rounded-lg border p-4 text-left transition',
                active
        ...
        {presets.map((p) => {
          ...
          return (
            <Button
              ...
              className={cn(
                'block h-auto w-full whitespace-normal rounded-lg border p-3 text-left transition',
                active
                  ? 'border-sky-500/50 bg-sky-500/5'
                  : 'border-black/8 bg-white hover:border-black/15 dark:border-white/8 dark:bg-zinc-900/40'
              )}
