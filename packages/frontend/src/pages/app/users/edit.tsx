                      ...
                      <TooltipProvider delayDuration={300}>
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <Button onClick={generateUsername} variant={'secondary'} size={'icon-lg'} type={'button'}>
                  ...
                  <FormItem className={'w-full'}>
                    ...
                    <div className={'flex gap-2'}>
                      ...
                      <TooltipProvider delayDuration={300}>
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <Button onClick={generatePassword} variant={'secondary'} size={'icon-lg'} type={'button'}>
                              <RefreshCw className={'size-3.5'} />
                            </Button>
                          </TooltipTrigger>
                          <TooltipContent className={'rounded-lg px-2.5 py-1.5 text-sm'}>{t('users.generate')}</TooltipContent>
    ...
    <>
      <FeatureCard>
        <FeatureCard.Header>
          ...
          <FeatureCard.Actions>
            <Button onClick={() => setGateOpen(true)} variant={'destructive'} size={'sm'}>
