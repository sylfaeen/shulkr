...
import { getDocContent } from '@shulkr/frontend/pages/app/docs/features/docs_content';
...
const SLUG_TO_NAV_KEY: Record<string, string> = {
  ...
  tasks: 'nav.docsTasks',
  'shulkr-core': 'nav.docsShulkrCore',
...
export function MarkdownPage() {
  ...
  const content = slug ? getDocContent(slug, i18n.language) : undefined;
