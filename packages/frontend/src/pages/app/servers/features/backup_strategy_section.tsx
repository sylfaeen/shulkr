...
import { Form, FormField, FormItem, FormControl, FormDescription, FormMessage } from '@shulkr/frontend/features/ui/base/form';
                        ...
                        <FormControl>
                          <SelectTrigger className={'w-full sm:w-80'}>
                            <SelectValue placeholder={t('backupStrategy.selectDestination')}>
                              {(value: string) => {
                                const dest = enabledDestinations.find((d) => d.id === value);

                                return dest ? `${dest.name} (${dest.bucket})` : t('backupStrategy.selectDestination');
                              }}
                            </SelectValue>
                          </SelectTrigger>
                        </FormControl>
