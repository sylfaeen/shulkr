              ...
              <TooltipTrigger
                render={
                  <Button
                    ...
                    icon={LogOut}
                    iconClass={'size-3.5 text-amber-500'}
                  />
                }
              />
              ...
              <TooltipTrigger
                render={
                  <Button
                    ...
                    icon={Ban}
                    iconClass={'size-3.5 text-red-500'}
                  />
                }
              />
              ...
              <TooltipTrigger
                render={
                  <Button
                    ...
                    onClick={handleDeop}
                    icon={ShieldOff}
                    iconClass={'size-3.5 text-zinc-400'}
                  />
                }
              />
            ...
            <DropdownMenu>
              <Tooltip>
                <TooltipTrigger
                  render={
                    <DropdownMenuTrigger
                      render={<Button variant={'ghost'} size={'icon-sm'} icon={Gamepad2} iconClass={'size-3.5 text-blue-500'} />}
                    />
                  }
                />
