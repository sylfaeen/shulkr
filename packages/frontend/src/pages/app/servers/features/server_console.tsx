      ...
      <div className={'flex max-w-full flex-1 flex-col overflow-hidden rounded-xl border border-white/10 bg-zinc-950'}>
          <div className={'flex shrink-0 items-center justify-between bg-zinc-900 px-4 py-2.5'}>
            <div className={'flex items-center gap-2.5'}>
              ...
              <span className={'text-[13px] font-semibold tracking-wide text-zinc-400 uppercase'}>
                {t('nav.console')}
              </span>
            </div>
            <div
          ...
          {canSendCommand && (
            <>
              ...
              <form
                ...
                className={
                  'flex items-center gap-2 bg-zinc-900 px-3 py-2.5 pb-[max(0.625rem,env(safe-area-inset-bottom))]'
                }
              >
