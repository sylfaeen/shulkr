...
import { PlayerActions, UnbanPanel } from '@shulkr/frontend/pages/app/servers/features/player_actions';
    ...
    <div className={'shrink-0'}>
      ...
      {expanded && (
        <div className={'mt-2 rounded-xl border border-black/6 bg-zinc-50/50 dark:border-white/6 dark:bg-zinc-900/50'}>
          ...
          <div className={'border-t border-black/4 px-4 py-2 dark:border-white/4'}>
            <UnbanPanel {...{ sendCommand }} />
          </div>
        </div>
      )}
    </div>
