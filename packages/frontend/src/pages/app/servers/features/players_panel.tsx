  ...
  return (
    <div className={'shrink-0'}>
      <Button
        ...
        className={
          'h-auto gap-1.5 p-0 text-sm font-normal text-zinc-500 transition-colors hover:bg-transparent hover:text-zinc-700 dark:text-zinc-400 dark:hover:text-zinc-300'
        }
      >
