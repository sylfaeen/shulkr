...
import { z } from 'zod';
import { ArrowRight, ArrowLeft, Server, Cpu, Zap, Check } from 'lucide-react';
        ...
        <div className={'mt-6 flex items-center justify-between'}>
          ...
          <div>
            {step !== 'summary' ? (
              ...
              <Button onClick={handleCreate} icon={Check} loading={createServer.isPending} disabled={createServer.isPending}>
      ...
      <div className={'grid grid-cols-2 gap-3'}>
        {RAM_PRESETS.map((preset, i) => (
          <Button
            ...
            onClick={() => onSelect(i)}
            className={cn(
              'h-auto flex-col items-start rounded-lg border p-3 text-left transition-colors',
              selectedPreset === i
