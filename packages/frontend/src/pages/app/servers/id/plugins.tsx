                ...
                <TooltipTrigger asChild>
                  <div className={'flex items-center'}>
                    <Switch
                      ...
                      disabled={!can('server:plugins:toggle')}
                    />
                  </div>
                </TooltipTrigger>
