                    ...
                    <div className={'flex flex-wrap items-center justify-between gap-2 sm:gap-4'}>
                      ...
                      <div className={'flex items-center gap-2'}>
                        {canBulkEnable && canToggle && (
                          <Button onClick={() => handleBulkToggle(true)} variant={'success'} size={'xs'} icon={Power} iconClass={'size-3.5'}>
                            {t('plugins.enable')}
                          </Button>
                        )}
                        {canBulkDisable && canToggle && (
                          <Button onClick={() => handleBulkToggle(false)} variant={'secondary'} size={'xs'} icon={PowerOff} iconClass={'size-3.5'}>
                        ...
                        {canDeletePlugin && (
                          <>
                            {bulkDeleteConfirm ? (
                              ...
                              <Button onClick={() => setBulkDeleteConfirm(true)} variant={'ghost-destructive'} size={'xs'} icon={Trash2} iconClass={'size-3.5'}>
                                {t('common.delete')}
                              </Button>
                            )}
                          </>
