      ...
      <table className={'w-full text-sm'}>
        ...
        >
          <tr className={'border-b border-black/6 dark:border-white/6'}>
            <SortableHeader label={t('playerProfile.stats.columns.item')} active={sort.column === 'name'} direction={sort.direction} onClick={() => toggle('name')} />
            <SortableHeader align={'right'} label={t('playerProfile.stats.columns.mined')} active={sort.column === 'mined'} direction={sort.direction} onClick={() => toggle('mined')} />
            <SortableHeader align={'right'} label={t('playerProfile.stats.columns.broken')} active={sort.column === 'broken'} direction={sort.direction} onClick={() => toggle('broken')} />
            <SortableHeader align={'right'} label={t('playerProfile.stats.columns.crafted')} active={sort.column === 'crafted'} direction={sort.direction} onClick={() => toggle('crafted')} />
            <SortableHeader align={'right'} label={t('playerProfile.stats.columns.used')} active={sort.column === 'used'} direction={sort.direction} onClick={() => toggle('used')} />
            <SortableHeader align={'right'} label={t('playerProfile.stats.columns.pickedUp')} active={sort.column === 'pickedUp'} direction={sort.direction} onClick={() => toggle('pickedUp')} />
            <SortableHeader align={'right'} label={t('playerProfile.stats.columns.dropped')} active={sort.column === 'dropped'} direction={sort.direction} onClick={() => toggle('dropped')} />
          </tr>
        </thead>
        <tbody>
          {sorted.map((row) => (
  ...
  return (
    ...
    >
      <table className={'w-full text-sm'}>
        ...
        >
          <tr className={'border-b border-black/6 dark:border-white/6'}>
            <SortableHeader label={t('playerProfile.stats.columns.mob')} active={sort.column === 'name'} direction={sort.direction} onClick={() => toggle('name')} />
            <SortableHeader align={'right'} label={t('playerProfile.stats.columns.killedByYou')} active={sort.column === 'killed'} direction={sort.direction} onClick={() => toggle('killed')} />
            <SortableHeader align={'right'} label={t('playerProfile.stats.columns.killedByThem')} active={sort.column === 'killedBy'} direction={sort.direction} onClick={() => toggle('killedBy')} />
          </tr>
        </thead>
        <tbody>
          {sorted.map((row) => (
...
function sortItemRows(rows: Array<ItemRow>, column: ItemSortColumn, direction: SortDirection): Array<ItemRow> {
  ...
  arr.sort((a, b) => {
    const cmp =
      column === 'name' ? formatMinecraftId(a.name).localeCompare(formatMinecraftId(b.name)) : a[column] - b[column];
