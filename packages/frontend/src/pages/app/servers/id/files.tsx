        ...
        {action === 'rename' ? (
          ...
          <div className={'flex items-center justify-end gap-1'}>
            <TooltipProvider delayDuration={300}>
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    ...
                    disabled={!isEditable || !can('server:files:write:edit')}
                    className={cn(
              ...
              {!isDirectory && can('server:files:read:download') && (
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button
