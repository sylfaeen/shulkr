      ...
      >
        ...
        >
          <div className={'flex items-center gap-2 sm:gap-3'}>
            <Button onClick={handleGoUp} variant={'secondary'} size={'sm'} disabled={currentPath === '/'}>
          ...
          <div className={'flex items-center gap-6'}>
            ...
            <div className={'flex items-center gap-2'}>
              <Button onClick={() => setShowUploadDialog(true)} variant={'secondary'} size={'sm'}>
              ...
              {showNewFolderInput ? (
                ...
                <Button onClick={() => setShowNewFolderInput(true)} variant={'secondary'} size={'sm'}>
