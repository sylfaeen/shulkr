...
import { Archive, Download, HardDrive, Loader2, Pencil, Plus, Settings, Trash2, Check, X } from 'lucide-react';
...
export function ServerBackupsPage() {
  ...
  return (
    <>
      ...
      <PageContent>
        <FeatureCard.Stack>
          <BackupStrategySection serverId={server.id} />
        ...
        <FeatureCard.Header>
          ...
          <FeatureCard.Actions className={'gap-2 sm:gap-6'}>
            ...
            <div className={'flex items-center justify-end gap-2'}>
              {canList && (
                <Button onClick={() => setSettingsOpen(true)} variant={'secondary'} icon={Settings}>
        ...
        <div className={'min-w-0'}>
          {editing ? (
            <div className={'flex items-center gap-0'}>
              ...
              <Button onClick={confirmRename} variant={'ghost'} size={'icon-xs'} className={'ml-1.5'} disabled={renamePending} icon={Check} iconClass={'size-3.5'} />
        ...
        {isCreating ? null : (
          <TooltipProvider delayDuration={300}>
            ...
            {canDelete && (
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button onClick={() => onRequestDelete(backup.filename)} variant={'ghost-destructive'} size={'icon-sm'} icon={Trash2} />
                </TooltipTrigger>
