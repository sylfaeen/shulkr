        ...
        <div className={'min-w-0'}>
          {editing ? (
            <div className={'flex items-center gap-0'}>
              {slugPrefix && (
                <span className={'font-jetbrains text-sm text-zinc-400 dark:text-zinc-500'}>{slugPrefix}</span>
              )}
              <Input
                autoFocus
                value={editValue}
                ...
                className={'font-jetbrains h-7 w-auto min-w-16 rounded-none border-x-0 border-t-0 border-b px-0 text-sm shadow-none focus-visible:ring-0'}
              />
