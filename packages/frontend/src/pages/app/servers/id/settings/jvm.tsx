...
function JvmConfigSection({ serverId }: { serverId: string }) {
  ...
  const handleSave = useCallback(
    async (data: JvmConfigFormValues) => {
                  ...
                  <FormField
                    ...
                    render={() => (
                      <FormItem className={'flex cursor-pointer items-center gap-3'}>
                        <FormControl>
                          <Switch checked={hasAikarFlags} onCheckedChange={handleToggleAikarFlags} />
                        </FormControl>
                        <div>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea placeholder={'-Dflag=value'} rows={8} {...field} />
                      </FormControl>
                    </FormItem>
                  )}
                />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className={'w-full'}>
                      <FormControl>
                        <Input type={'number'} min={1024} max={65535} className={'w-full sm:w-48'} {...field} />
                      </FormControl>
                ...
                <FormField
                  ...
                  render={() => (
                    <FormItem className={'w-full'}>
                      <FormControl>
                        <Select
                          value={javaMode === 'bundled' ? form.getValues('java_path') : 'custom'}
                          onValueChange={(val) => {
                            if (val === 'custom') {
                ...
                {javaMode === 'custom' && (
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormControl>
                          <Input type={'text'} placeholder={t('settings.customJavaPathPlaceholder')} {...field} />
                        </FormControl>
