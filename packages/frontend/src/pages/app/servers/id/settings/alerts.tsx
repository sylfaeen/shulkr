...
import type { AlertFormValues, AlertMetric, AlertOperator } from '@shulkr/frontend/pages/app/servers/dialogs/alert_form';
              ...
              rules.map((rule) => (
                <FeatureCard.Row key={rule.id} interactive onClick={() => canUpdate && setEditRule(rule as AlertRuleProps)}>
                  ...
                  <div className={'flex shrink-0 items-center gap-2'} onClick={(e) => e.stopPropagation()}>
                    ...
                    {canDelete && (
                      <Button variant={'ghost-destructive'} size={'icon-sm'} onClick={() => setGateAlertId(rule.id)}>
