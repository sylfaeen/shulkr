  ...
  return (
    <>
      ...
      <PageContent>
        <div
          className={
            'flex min-h-0 flex-1 flex-col overflow-hidden rounded-xl bg-zinc-100/80 p-1 shadow-inner dark:bg-zinc-800/80'
          }
        >
          <div className={cn('shadow-inner-xs flex min-h-0 flex-1 flex-col overflow-hidden rounded-lg', MONACO_CONTAINER_CLASS)}>
            ...
            >
              ...
              <div className={'flex items-center gap-2'}>
                ...
                {hasChanges && <span className={'text-[11px] font-medium text-amber-500'}>{t('files.unsavedChanges')}</span>}
              </div>
            </div>
          </div>
        </div>
