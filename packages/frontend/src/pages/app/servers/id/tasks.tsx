...
import { ArrowRight, ChevronDown, Clock, File, Folder, Globe, Loader2, LoaderCircle, Pencil, Plus, Terminal, Trash2 } from 'lucide-react';
            ...
            <>
              <TooltipProvider delayDuration={300}>
                ...
                {canUpdate && (
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button onClick={() => onEdit(task)} variant={'ghost'} size={'icon-sm'}>
                ...
                <div key={exec.id}>
                  ...
                  >
                    ...
                    <div className={'flex items-center gap-2'}>
                      ...
                      {exec.status === 'running' && (
                        <span className={'text-[11px] text-blue-500'}>{t('tasks.running')}</span>
                      )}
                      <ChevronDown
                        className={cn(
