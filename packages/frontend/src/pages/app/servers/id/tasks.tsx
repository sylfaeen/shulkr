    ...
    <div className={'mt-2 flex flex-wrap items-center gap-1'}>
      ...
      {hiddenCount > 0 && (
        <button
          ...
          className={
            'font-jetbrains inline-flex items-center rounded-md border border-black/6 bg-zinc-200/60 px-1.5 py-0.5 text-sm font-medium text-zinc-500 transition-colors hover:bg-zinc-200 hover:text-zinc-700 dark:border-white/8 dark:bg-zinc-700/60 dark:text-zinc-400 dark:hover:bg-zinc-700 dark:hover:text-zinc-300'
          }
        >
