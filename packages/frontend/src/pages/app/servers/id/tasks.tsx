...
import { ArrowRight, ChevronDown, Clock, File, Folder, Globe, Loader2, Pencil, Play, Plus, Terminal, Trash2 } from 'lucide-react';
            ...
            <>
              <TooltipProvider delayDuration={300}>
                ...
                {canRun && (
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button onClick={() => onRun(task.id)} variant={'ghost'} size={'icon-sm'}>
