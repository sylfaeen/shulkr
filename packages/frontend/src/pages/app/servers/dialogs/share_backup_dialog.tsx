...
function ShareLinkRow({
  ...
  return (
    <div
      className={cn('flex flex-col gap-2 rounded-lg border border-zinc-200 p-3 dark:border-zinc-700', inactive && 'opacity-60')}
    >
      <div className={'flex items-center gap-2'}>
        <Input
          readOnly
          value={fullUrl}
          className={'font-jetbrains h-8 text-xs'}
