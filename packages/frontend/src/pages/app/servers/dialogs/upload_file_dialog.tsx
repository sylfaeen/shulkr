...
import { Form, FormField, FormItem, FormLabel, FormControl } from '@shulkr/frontend/features/ui/base/form';
    ...
    <Form {...form}>
      <form id={'upload-file-form'} onSubmit={form.handleSubmit(handleSubmit)}>
        ...
        <DialogFooter>
          ...
          <Button type={'submit'} disabled={isPending || selectedFiles.length === 0} loading={isPending} icon={Upload}>
