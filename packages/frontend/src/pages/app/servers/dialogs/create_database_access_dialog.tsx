...
import { useCreateDatabaseAccess } from '@shulkr/frontend/hooks/use_databases';
          ...
          <>
            <DialogBody>
              <div className={'space-y-4'}>
                ...
                />
                <a
                  href={credentials.caCertificateUrl}
...
function ClientCertificateBlock({ certificate, privateKey }: { certificate: string; privateKey: string }) {
  const { t } = useTranslation();
