              ...
              <TooltipProvider delayDuration={300}>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button onClick={handleGenerateUsername} variant={'secondary'} size={'icon-lg'} icon={RefreshCw} iconClass={'size-3.5'} />
                  </TooltipTrigger>
          ...
          <FormItem>
            ...
            <div className={'flex gap-2'}>
              ...
              <TooltipProvider delayDuration={300}>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button onClick={handleGeneratePassword} variant={'secondary'} size={'icon-lg'} icon={RefreshCw} iconClass={'size-3.5'} />
                  </TooltipTrigger>
                  <TooltipContent className={'rounded-lg px-2.5 py-1.5 text-sm'}>
                    {t('settings.sftp.dialog.generate')}
                  </TooltipContent>
