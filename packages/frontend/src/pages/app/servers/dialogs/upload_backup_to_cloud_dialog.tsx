              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Select value={field.value} onValueChange={field.onChange} disabled={isPending} modal={false}>
                      <FormControl>
                        <SelectTrigger>
                          <SelectValue placeholder={t('backups.uploadToCloud.selectDestination')}>
                            {(value: string) => {
                              ...
                              return dest ? `${dest.name} (${dest.bucket})` : t('backups.uploadToCloud.selectDestination');
                            }}
                          </SelectValue>
                        </SelectTrigger>
                      </FormControl>
