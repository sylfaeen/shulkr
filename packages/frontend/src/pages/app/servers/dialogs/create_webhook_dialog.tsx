      ...
      <DialogContent className={'max-w-2xl'}>
        ...
        <DialogBody className={'space-y-4'}>
          <WebhookFormFields
            ...
            {...{ name, url, format, language, events, defaultTemplates, getMessageValue, isMessageCustom, getResolvedLength, focusedEvent }}
          />
        </DialogBody>
        <DialogFooter>
      ...
      <div className={'space-y-2'}>
        ...
        {WEBHOOK_EVENTS.map((group) => (
          <div key={group.group} className={'space-y-1'}>
            <p className={'text-xs font-medium uppercase text-zinc-500'}>{t(`webhooks.group.${group.group}`)}</p>
