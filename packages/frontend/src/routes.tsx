...
import { ServerDatabasesPage } from '@shulkr/frontend/pages/app/servers/id/databases';
import { ServerDatabaseViewerPage } from '@shulkr/frontend/pages/app/servers/id/database_viewer';
...
import { FirstServerWizardPage } from '@shulkr/frontend/pages/app/first_server';
import { SharesPage } from '@shulkr/frontend/pages/app/shares/shares';
...
const sharesRoute = createRoute({
  getParentRoute: () => mainLayoutRoute,
  path: 'public-files',
  beforeLoad: requirePermission('shares:files'),
...
const firstServerRoute = createRoute({
  getParentRoute: () => mainLayoutRoute,
  path: 'first-server',
  beforeLoad: requirePermission('servers:create'),
  component: FirstServerWizardPage,
});
...
const serverDatabasesRoute = createRoute({
  getParentRoute: () => serverLayoutRoute,
  path: 'databases',
  beforeLoad: requirePermission('server:databases'),
  component: ServerDatabasesPage,
});

const serverDatabaseViewerRoute = createRoute({
  getParentRoute: () => serverLayoutRoute,
  path: 'databases/$databaseId',
  beforeLoad: requirePermission('server:databases:browse'),
  component: ServerDatabaseViewerPage,
});
