...
function requirePermission(...required: Array<string>) {
  return () => {
...
const serverFilesRoute = createRoute({
  getParentRoute: () => serverLayoutRoute,
  path: 'files',
  beforeLoad: requirePermission('files:read', 'files:write'),
...
const serverFileEditRoute = createRoute({
  getParentRoute: () => serverLayoutRoute,
  path: 'files/edit',
  beforeLoad: requirePermission('files:write'),
...
const serverDbViewerRoute = createRoute({
  getParentRoute: () => serverLayoutRoute,
  path: 'files/db',
  beforeLoad: requirePermission('files:read'),
