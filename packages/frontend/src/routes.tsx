...
import { ServerWebhooksPage } from '@shulkr/frontend/pages/app/servers/id/webhooks';
import { ServerAlertsPage } from '@shulkr/frontend/pages/app/servers/id/alerts';
...
const serverSettingsJvmRoute = createRoute({
  getParentRoute: () => serverLayoutRoute,
  path: 'settings/jvm',
  beforeLoad: requirePermission('server:jvm'),
...
const serverWebhooksRoute = createRoute({
  getParentRoute: () => serverLayoutRoute,
  path: 'webhooks',
...
const serverAlertsRoute = createRoute({
  getParentRoute: () => serverLayoutRoute,
  path: 'alerts',
