    ...
    <div className={'animate-fade-in'}>
      <div className={'shadow-card rounded-xl border border-black/10 bg-white p-6 dark:border-white/10 dark:bg-zinc-800'}>
        <div className={'mb-5 flex flex-col items-center text-center'}>
          ...
          <h2 className={'text-lg font-semibold text-zinc-900 dark:text-zinc-100'}>{t('auth.totp.title')}</h2>
        ...
        <div className={'space-y-4'}>
          {error && (
            <div className={'flex items-center gap-2.5 rounded-lg bg-red-50 px-3.5 py-2.5 text-sm text-red-600 dark:bg-red-950'}>
