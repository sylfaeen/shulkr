...
export function SkeletonListRow({ className }: { className?: string }) {
  return (
    <div className={cn('flex items-center gap-3 rounded-lg border border-black/6 bg-white p-3 dark:border-white/6 dark:bg-zinc-900/40', className)}>
...
export function SkeletonChart({ className }: { className?: string }) {
  return (
    <div className={cn('space-y-3 rounded-lg border border-black/6 bg-white p-4 dark:border-white/6 dark:bg-zinc-900/40', className)}>
