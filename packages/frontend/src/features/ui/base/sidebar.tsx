...
import { useIsMobile } from '@shulkr/frontend/hooks/use-mobile';
import { Button } from '@shulkr/frontend/features/ui/base/button';
import { Input } from '@shulkr/frontend/features/ui/base/input';
import { Separator } from '@shulkr/frontend/features/ui/base/separator';
import { Sheet, SheetContent, SheetDescription, SheetHeader, SheetTitle } from '@shulkr/frontend/features/ui/base/sheet';
...
function SidebarProvider({
  ...
  // We add a state so that we can do data-state={'expanded'} or "collapsed". This makes it easier to style the sidebar with Tailwind classes.
...
function SidebarGroupLabel({ className, render, ...props }: React.ComponentProps<'div'> & { render?: useRender.RenderProp }) {
  return useRender({
    render: render ?? <div />,
    props: {
...
function SidebarGroupAction({ className, render, ...props }: React.ComponentProps<'button'> & { render?: useRender.RenderProp }) {
  return useRender({
