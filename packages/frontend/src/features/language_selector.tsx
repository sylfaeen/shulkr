      ...
      <DropdownMenuTrigger
        render={
          <Button
            ...
            size={'icon'}
            className={
              'rounded-lg text-zinc-600 transition-all duration-(--duration-fast) hover:bg-zinc-100 hover:text-zinc-900 dark:text-zinc-400 dark:hover:bg-zinc-800 dark:hover:text-zinc-100'
            }
