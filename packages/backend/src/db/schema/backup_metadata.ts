...
export type CloudUploadStatus = 'uploading' | 'failed';
...
export const backupMetadata = sqliteTable('backup_metadata', {
  ...
  cloud_upload_status: text('cloud_upload_status').$type<CloudUploadStatus>(),
  cloud_upload_error: text('cloud_upload_error'),
});
