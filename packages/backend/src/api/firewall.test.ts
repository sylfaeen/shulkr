...
// Story 59.6 ACs 8/9/11 adapted to the unified firewall model: rules now carry
// an `action` (allow|deny) and an optional `from_ip`, with `port` accepting
// either a single number or a "low:high" range (or null for any).
