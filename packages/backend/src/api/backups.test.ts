...
// Story 59.3 ACs adapted to the actual contract.
// Cloud backup (AC2), restore (AC3/AC4), retention preservation (AC7/AC8) and the racy delete-during-backup (AC9) are out of scope here, they belong to follow-up coverage stories that drive the cloud_backup_strategy and task_scheduler paths end-to-end.
