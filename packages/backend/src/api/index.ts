...
import { databasesRoutes } from '@shulkr/backend/api/databases';
...
import { createPublicFilesRoutes } from '@shulkr/backend/api/public_files';
...
export function createApiRouter(deps: AppDeps) {
  return s.router(contract, {
    ...
    wizard: wizardRoutes,
    agents: agentsRoutes,
    publicFiles: createPublicFilesRoutes(deps),
  });
}
