...
export const PERMISSION_TREE = [
    ...
    groups: [
      ...
      },
      {
        ...
        actions: [
          ...
          'server:databases:reveal',
          'server:databases:browse',
          'server:databases:rotate',
          'server:databases:delete',
          'server:databases:access',
        ],
      },
      {
        key: 'server:domains',
      ...
      {
        key: 'server:alerts',
        actions: ['server:alerts:list', 'server:alerts:create', 'server:alerts:update', 'server:alerts:delete'],
      },
      {
        key: 'server:webhooks',
        actions: [
          ...
          'server:webhooks:update',
          'server:webhooks:delete',
          'server:webhooks:test',
        ],
      },
      { key: 'server:agents', actions: ['server:agents:manage'] },
      {
  ...
  {
    section: 'shares',
    groups: [{ key: 'shares:files', actions: ['shares:files:list', 'shares:files:upload', 'shares:files:manage'] }],
  },
  {
    section: 'settings',
    groups: [
      ...
      { key: 'settings:databases', actions: ['settings:databases:read'] },
      {
        key: 'settings:cloud-destinations',
        actions: [
          'settings:cloud-destinations:list',
          'settings:cloud-destinations:create',
          'settings:cloud-destinations:update',
          'settings:cloud-destinations:delete',
          'settings:cloud-destinations:test',
        ],
      },
    ],
  },
