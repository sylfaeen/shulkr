...
// Why a domain failed the DNS pre-flight check run before the panel domain is applied. See DomainDnsMismatchError in the backend domain service.
export const dnsFailureReasonSchema = z.enum(['mismatch', 'propagating', 'unresolved']);
