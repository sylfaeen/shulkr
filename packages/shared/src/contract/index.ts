...
import { cloudDestinationsContract } from '@shulkr/shared/contract/cloud_destinations';
import { wizardContract } from '@shulkr/shared/contract/wizard';
import { agentsContract } from '@shulkr/shared/contract/agents';
import { databasesContract } from '@shulkr/shared/contract/database';
import { publicFilesContract } from '@shulkr/shared/contract/public_files';
...
export const contract = c.router({
  ...
  cloudDestinations: cloudDestinationsContract,
  wizard: wizardContract,
  agents: agentsContract,
  databases: databasesContract,
  publicFiles: publicFilesContract,
});
