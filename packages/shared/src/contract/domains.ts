...
import { z } from 'zod';
import { addDomainSchema, dnsFailureReasonSchema, domainTypeSchema, setPanelDomainSchema } from '@shulkr/shared/schemas/domain';
