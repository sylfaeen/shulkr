...
[![Discord](https://img.shields.io/badge/discord-join%20community-5865F2?logo=discord&logoColor=white)](https://discord.gg/6PgD9cBFvu)
...
[Documentation](https://github.com/sylfaeen/shulkr/wiki) · [Installation](https://github.com/sylfaeen/shulkr/wiki/Installation) · [Report a bug](https://github.com/sylfaeen/shulkr/issues)
...
| Layer | Technologies |
|---|---|
| **Backend** | Fastify, ts-rest, SQLite, Drizzle ORM |
...
> **Prerequisites:** a Linux server with SSH access and root privileges. **Debian 13 (trixie) is the recommended distribution**; Debian 12 and Ubuntu 22.04+ also work. The installer automatically handles the rest.

For detailed instructions, advanced configuration and deployment options, see the **[full documentation](https://github.com/sylfaeen/shulkr/wiki/Installation)**.

## Documentation

The complete documentation is available on the **[GitHub Wiki](https://github.com/sylfaeen/shulkr/wiki)**:

- **[Introduction](https://github.com/sylfaeen/shulkr/wiki)**: Discover what Shulkr is and why use it
- **[Installation](https://github.com/sylfaeen/shulkr/wiki/Installation)**: Step-by-step installation guide
- **[Configuration](https://github.com/sylfaeen/shulkr/wiki/Configuration)**: Customize your setup
