...
[Documentation](https://shulkr.dev/docs/introduction/) · [Installation](https://shulkr.dev/docs/installation/) · [Report a bug](https://github.com/sylfaeen/shulkr/issues)
...
For detailed instructions, advanced configuration and deployment options, see the **[full documentation](https://shulkr.dev/docs/installation/)**.
...
- **[Installation](https://shulkr.dev/docs/installation/)** — Step-by-step installation guide
- **[Configuration](https://shulkr.dev/docs/configuration/)** — Customize your setup
